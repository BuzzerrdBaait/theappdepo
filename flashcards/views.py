...
def create_deck(request):
    ...
    if request.method == 'POST':
            ...
            if user.is_verified == 'Y' and user_decks_count >= 20:
                ...
                return redirect('flashcards:user_profile', user_pk=request.user.pk)
    ...
    if request.user == deck.user:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return redirect('flashcards:view_deck', deck_id=deck.id)
...
def edit_note(request, note_id):
       ...
       if request.method == 'POST':
           ...
           if form.is_valid():
               ...
               return redirect('flashcards:view_deck', deck_id=note.deck.id)
...
def edit_deck(request, deck_id):
    ...
    if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return redirect('flashcards:view_deck', deck_id=deck_id)
...
def about_us(request):
    ...
    return render(request, 'flashcards:about_us.html')
...
def clep_resources(request):
    ...
    return render(request, 'flashcards:clep_resources.html')
